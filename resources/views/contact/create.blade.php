...
@section('title', 'お問い合わせ - オヤズナ | 高所ロープ作業の見積もり・相場データベース【高所の窓ガラス清掃・外壁塗装・外壁補修など】')
...
<div class="max-w-4xl mx-auto px-4 py-6 md:py-8">
    ...
    <form action="{{ route('contact.store') }}" method="POST" class="bg-white shadow p-4 md:p-8 space-y-6">
        @csrf
