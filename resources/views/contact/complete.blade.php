...
@section('title', 'お問い合わせ完了 - オヤズナ | 高所ロープ作業の見積もり・相場データベース【高所の窓ガラス清掃・外壁塗装・外壁補修など】')
    ...
    <div class="bg-white shadow p-6 md:p-8 text-center">
        ...
        <div class="space-y-4 md:space-y-0 md:space-x-4 md:flex md:justify-center">
            ...
            <a href="{{ route('companies.index') }}" 
               class="inline-block bg-gray-600 text-white px-8 py-3 font-medium hover:bg-gray-700 transition-colors">
                業者一覧を見る
            </a>
        </div>
    </div>
