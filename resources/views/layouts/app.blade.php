...
<body class="bg-blue-50">
    <nav class="sticky top-0 z-50 shadow-sm border-b overflow-visible bg-[linear-gradient(to_right,#66ccff_0%,#66ccff_17%,white_24%,white_100%)]">
        ...
        <div class="hidden md:flex h-20 overflow-visible w-full">
            ...
            <!-- 現調依頼するボタン -->
            <a href="{{ route('quote.create') }}" class="flex items-center justify-center gap-2 bg-orange-500 hover:bg-orange-600 transition-colors text-white font-bold text-lg px-10 h-full glowing-button">
