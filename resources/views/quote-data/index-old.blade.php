...
@section('title', '見積もりデータ一覧 - おやづな | 高所ロープ作業の見積もり・相場データベース')
                    ...
                    <div class="bg-white rounded-2xl border border-gray-200 shadow-lg overflow-hidden">
                        ...
                        <div class="p-4 md:p-8">
                            ...
                            <div id="tab-window" class="tab-content">
                                <h3 class="text-lg md:text-xl font-bold text-gray-900 mb-4 md:mb-6">窓ガラス清掃の見積もりデータ</h3>
                                    ...
                                    <div class="bg-white border border-gray-300 rounded-lg shadow-sm">
                                        ...
                                        <div class="p-4 md:p-6">
                                            <div class="overflow-x-auto -mx-4 md:mx-0">
                                                <table class="min-w-full text-xs md:text-sm">
                                                    ...
                                                    <tbody class="divide-y divide-gray-200">
                                                        <tr class="bg-gray-50">
                                                            <td class="px-2 md:px-4 py-2 text-xs md:text-sm font-medium">定期窓ガラス清掃（年4回）</td>
                                                        ...
                                                        <tr>
                                                            <td class="px-2 md:px-4 py-2 text-xs md:text-sm font-medium">外装ガラス清掃費</td>
                                                            <td class="px-4 py-2 text-center text-sm"></td>
                                                            <td class="px-4 py-2 text-center text-sm"></td>
                                                            <td class="px-4 py-2 text-center text-sm"></td>
                                                            <td class="px-4 py-2 text-center text-sm"></td>
                                                        ...
                                                        <tr>
                                                            <td class="px-2 md:px-4 py-2 text-xs md:text-sm pl-8">① 外装ガラス/外面のみ</td>
                                                            <td class="px-4 py-2 text-center text-sm">㎡</td>
                                                        ...
                                                        <tr>
                                                            <td class="px-2 md:px-4 py-2 text-xs md:text-sm pl-8">② 手摺ガラス/両面</td>
                                                            <td class="px-4 py-2 text-center text-sm">㎡</td>
                                                        ...
                                                        <tr>
                                                            <td class="px-2 md:px-4 py-2 text-xs md:text-sm">地上監視員配置費</td>
                                                        ...
                                                        <tr>
                                                            <td class="px-2 md:px-4 py-2 text-xs md:text-sm">資材搬入出費</td>
                                            ...
                                            <div class="mt-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                                                <div class="text-xs md:text-sm text-gray-600">東京都 | 施工面積: 396㎡</div>
                                                <div class="text-sm md:text-lg font-bold text-blue-600">合計: ¥208,520</div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="p-4 md:p-6">
                                            <div class="overflow-x-auto -mx-4 md:mx-0">
                                                <table class="min-w-full text-xs md:text-sm">
                                                    ...
                                                    <tbody class="divide-y divide-gray-200">
                                                        <tr>
                                                            <td class="px-2 md:px-4 py-2 text-xs md:text-sm">定期窓ガラス清掃（月1回）</td>
                                            ...
                                            <div class="mt-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                                                <div class="text-xs md:text-sm text-gray-600">大阪府 | 施工面積: 150㎡</div>
                                                <div class="text-sm md:text-lg font-bold text-blue-600">合計: ¥85,000</div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="p-4 md:p-6">
                                            <div class="overflow-x-auto -mx-4 md:mx-0">
                                                <table class="min-w-full text-xs md:text-sm">
                                                    ...
                                                    <tbody class="divide-y divide-gray-200">
                                                        <tr>
                                                            <td class="px-2 md:px-4 py-2 text-xs md:text-sm">スポット窓ガラス清掃</td>
                                                            <td class="px-4 py-2 text-center text-sm">㎡</td>
                                                        ...
                                                        <tr>
                                                            <td class="px-2 md:px-4 py-2 text-xs md:text-sm">出張費</td>
                                                            <td class="px-4 py-2 text-center text-sm">式</td>
                                                            <td class="px-4 py-2 text-center text-sm">1.00</td>
                                            ...
                                            <div class="mt-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                                                <div class="text-xs md:text-sm text-gray-600">愛知県 | 施工面積: 80㎡</div>
                                                <div class="text-sm md:text-lg font-bold text-blue-600">合計: ¥45,000</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="tab-inspection" class="tab-content hidden">
                                <h3 class="text-lg md:text-xl font-bold text-gray-900 mb-4 md:mb-6">外壁調査の見積もりデータ</h3>
                                        ...
                                        <div class="p-4 md:p-6">
                                            <div class="overflow-x-auto -mx-4 md:mx-0">
                                                <table class="min-w-full text-xs md:text-sm">
                                                    ...
                                                    <tbody class="divide-y divide-gray-200">
                                                        <tr class="bg-gray-50">
                                                            <td class="px-2 md:px-4 py-2 text-xs md:text-sm font-medium">外壁全面点検調査</td>
                                                            <td class="px-4 py-2 text-center text-sm"></td>
                                                            <td class="px-4 py-2 text-center text-sm"></td>
                                                            <td class="px-4 py-2 text-center text-sm"></td>
                                                            <td class="px-4 py-2 text-center text-sm"></td>
                                                        ...
                                                        <tr>
                                                            <td class="px-2 md:px-4 py-2 text-xs md:text-sm pl-8">① 目視点検調査</td>
                                                            <td class="px-4 py-2 text-center text-sm">㎡</td>
                                                        ...
                                                        <tr>
                                                            <td class="px-2 md:px-4 py-2 text-xs md:text-sm pl-8">② 打診調査</td>
                                                            <td class="px-4 py-2 text-center text-sm">㎡</td>
                                                        ...
                                                        <tr>
                                                            <td class="px-2 md:px-4 py-2 text-xs md:text-sm">調査報告書作成</td>
                                                            <td class="px-4 py-2 text-center text-sm">式</td>
                                                            <td class="px-4 py-2 text-center text-sm">1.00</td>
                                            ...
                                            <div class="mt-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                                                <div class="text-xs md:text-sm text-gray-600">東京都 | 調査面積: 1,200㎡</div>
                                                <div class="text-sm md:text-lg font-bold text-blue-600">合計: ¥350,000</div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="p-4 md:p-6">
                                            <div class="overflow-x-auto -mx-4 md:mx-0">
                                                <table class="min-w-full text-xs md:text-sm">
                                                    ...
                                                    <tbody class="divide-y divide-gray-200">
                                                        <tr>
                                                            <td class="px-2 md:px-4 py-2 text-xs md:text-sm">劣化診断調査</td>
                                                            <td class="px-4 py-2 text-center text-sm">㎡</td>
                                            ...
                                            <div class="mt-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                                                <div class="text-xs md:text-sm text-gray-600">神奈川県 | 調査面積: 800㎡</div>
                                                <div class="text-sm md:text-lg font-bold text-blue-600">合計: ¥280,000</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="tab-repair" class="tab-content hidden">
                                <h3 class="text-lg md:text-xl font-bold text-gray-900 mb-4 md:mb-6">外壁補修の見積もりデータ</h3>
                                        ...
                                        <div class="p-4 md:p-6">
                                            <div class="overflow-x-auto -mx-4 md:mx-0">
                                                <table class="min-w-full text-xs md:text-sm">
                                                    ...
                                                    <tbody class="divide-y divide-gray-200">
                                                        <tr>
                                                            <td class="px-2 md:px-4 py-2 text-xs md:text-sm">ひび割れ補修工事</td>
                                            ...
                                            <div class="mt-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                                                <div class="text-xs md:text-sm text-gray-600">大阪府 | 補修箇所: 50m</div>
                                                <div class="text-sm md:text-lg font-bold text-blue-600">合計: ¥120,000</div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="p-4 md:p-6">
                                            <div class="overflow-x-auto -mx-4 md:mx-0">
                                                <table class="min-w-full text-xs md:text-sm">
                                                    ...
                                                    <tbody class="divide-y divide-gray-200">
                                                        <tr>
                                                            <td class="px-2 md:px-4 py-2 text-xs md:text-sm">外壁剥離部補修</td>
                                                            <td class="px-4 py-2 text-center text-sm">㎡</td>
                                            ...
                                            <div class="mt-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                                                <div class="text-xs md:text-sm text-gray-600">愛知県 | 補修面積: 30㎡</div>
                                                <div class="text-sm md:text-lg font-bold text-blue-600">合計: ¥180,000</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="tab-painting" class="tab-content hidden">
                                <h3 class="text-lg md:text-xl font-bold text-gray-900 mb-4 md:mb-6">外壁塗装の見積もりデータ</h3>
                                        ...
                                        <div class="p-4 md:p-6">
                                            <div class="overflow-x-auto -mx-4 md:mx-0">
                                                <table class="min-w-full text-xs md:text-sm">
                                                    ...
                                                    <tbody class="divide-y divide-gray-200">
                                                        <tr>
                                                            <td class="px-2 md:px-4 py-2 text-xs md:text-sm">外壁部分塗装工事</td>
                                                            <td class="px-4 py-2 text-center text-sm">㎡</td>
                                            ...
                                            <div class="mt-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                                                <div class="text-xs md:text-sm text-gray-600">福岡県 | 塗装面積: 100㎡</div>
                                                <div class="text-sm md:text-lg font-bold text-blue-600">合計: ¥250,000</div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="p-4 md:p-6">
                                            <div class="overflow-x-auto -mx-4 md:mx-0">
                                                <table class="min-w-full text-xs md:text-sm">
                                                    ...
                                                    <tbody class="divide-y divide-gray-200">
                                                        <tr>
                                                            <td class="px-2 md:px-4 py-2 text-xs md:text-sm">色合わせ塗装工事</td>
                                                            <td class="px-4 py-2 text-center text-sm">㎡</td>
                                                        ...
                                                        <tr>
                                                            <td class="px-2 md:px-4 py-2 text-xs md:text-sm">調色費用</td>
                                                            <td class="px-4 py-2 text-center text-sm">式</td>
                                                            <td class="px-4 py-2 text-center text-sm">1.00</td>
                                            ...
                                            <div class="mt-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                                                <div class="text-xs md:text-sm text-gray-600">兵庫県 | 塗装面積: 150㎡</div>
                                                <div class="text-sm md:text-lg font-bold text-blue-600">合計: ¥320,000</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="tab-bird_control" class="tab-content hidden">
                                <h3 class="text-lg md:text-xl font-bold text-gray-900 mb-4 md:mb-6">鳥害対策の見積もりデータ</h3>
                                        ...
                                        <div class="p-4 md:p-6">
                                            <div class="overflow-x-auto -mx-4 md:mx-0">
                                                <table class="min-w-full text-xs md:text-sm">
                                                    ...
                                                    <tbody class="divide-y divide-gray-200">
                                                        <tr>
                                                            <td class="px-2 md:px-4 py-2 text-xs md:text-sm">防鳥ネット設置工事</td>
                                                            <td class="px-4 py-2 text-center text-sm">㎡</td>
                                            ...
                                            <div class="mt-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                                                <div class="text-xs md:text-sm text-gray-600">東京都 | 設置面積: 200㎡</div>
                                                <div class="text-sm md:text-lg font-bold text-blue-600">合計: ¥150,000</div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="p-4 md:p-6">
                                            <div class="overflow-x-auto -mx-4 md:mx-0">
                                                <table class="min-w-full text-xs md:text-sm">
                                                    ...
                                                    <tbody class="divide-y divide-gray-200">
                                                        <tr>
                                                            <td class="px-2 md:px-4 py-2 text-xs md:text-sm">鳥の巣除去作業</td>
                                            ...
                                            <div class="mt-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                                                <div class="text-xs md:text-sm text-gray-600">千葉県 | 除去箇所: 5箇所</div>
                                                <div class="text-sm md:text-lg font-bold text-blue-600">合計: ¥80,000</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="tab-sign" class="tab-content hidden">
                                <h3 class="text-lg md:text-xl font-bold text-gray-900 mb-4 md:mb-6">看板作業の見積もりデータ</h3>
                                        ...
                                        <div class="p-4 md:p-6">
                                            <div class="overflow-x-auto -mx-4 md:mx-0">
                                                <table class="min-w-full text-xs md:text-sm">
                                                    ...
                                                    <tbody class="divide-y divide-gray-200">
                                                        <tr>
                                                            <td class="px-2 md:px-4 py-2 text-xs md:text-sm">看板設置作業</td>
                                                        ...
                                                        <tr>
                                                            <td class="px-2 md:px-4 py-2 text-xs md:text-sm">高所作業車使用料</td>
                                            ...
                                            <div class="mt-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                                                <div class="text-xs md:text-sm text-gray-600">大阪府 | 看板サイズ: 3m×2m</div>
                                                <div class="text-sm md:text-lg font-bold text-blue-600">合計: ¥200,000</div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="p-4 md:p-6">
                                            <div class="overflow-x-auto -mx-4 md:mx-0">
                                                <table class="min-w-full text-xs md:text-sm">
                                                    ...
                                                    <tbody class="divide-y divide-gray-200">
                                                        <tr>
                                                            <td class="px-2 md:px-4 py-2 text-xs md:text-sm">看板撤去作業</td>
                                                            <td class="px-4 py-2 text-center text-sm">枚</td>
                                                            <td class="px-4 py-2 text-center text-sm">1.00</td>
                                            ...
                                            <div class="mt-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                                                <div class="text-xs md:text-sm text-gray-600">神奈川県 | 看板サイズ: 2m×1.5m</div>
                                                <div class="text-sm md:text-lg font-bold text-blue-600">合計: ¥80,000</div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div id="tab-leak" class="tab-content hidden">
                                <h3 class="text-lg md:text-xl font-bold text-gray-900 mb-4 md:mb-6">雨漏り調査の見積もりデータ</h3>
                                        ...
                                        <div class="p-4 md:p-6">
                                            <div class="overflow-x-auto -mx-4 md:mx-0">
                                                <table class="min-w-full text-xs md:text-sm">
                                                    ...
                                                    <tbody class="divide-y divide-gray-200">
                                                        <tr>
                                                            <td class="px-2 md:px-4 py-2 text-xs md:text-sm">雨漏り散水試験</td>
                                                            <td class="px-4 py-2 text-center text-sm">箇所</td>
                                            ...
                                            <div class="mt-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                                                <div class="text-xs md:text-sm text-gray-600">埼玉県 | 調査箇所: 3箇所</div>
                                                <div class="text-sm md:text-lg font-bold text-blue-600">合計: ¥120,000</div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="p-4 md:p-6">
                                            <div class="overflow-x-auto -mx-4 md:mx-0">
                                                <table class="min-w-full text-xs md:text-sm">
                                                    ...
                                                    <tbody class="divide-y divide-gray-200">
                                                        <tr>
                                                            <td class="px-2 md:px-4 py-2 text-xs md:text-sm">雨漏り原因調査</td>
                                                            <td class="px-4 py-2 text-center text-sm">箇所</td>
                                                            <td class="px-4 py-2 text-center text-sm">1.00</td>
                                            ...
                                            <div class="mt-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                                                <div class="text-xs md:text-sm text-gray-600">愛知県 | 調査箇所: 1箇所</div>
                                                <div class="text-sm md:text-lg font-bold text-blue-600">合計: ¥60,000</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="tab-other" class="tab-content hidden">
                                <h3 class="text-lg md:text-xl font-bold text-gray-900 mb-4 md:mb-6">その他の見積もりデータ</h3>
                                        ...
                                        <div class="p-4 md:p-6">
                                            <div class="overflow-x-auto -mx-4 md:mx-0">
                                                <table class="min-w-full text-xs md:text-sm">
                                                    ...
                                                    <tbody class="divide-y divide-gray-200">
                                                        <tr>
                                                            <td class="px-2 md:px-4 py-2 text-xs md:text-sm">特殊清掃作業</td>
                                                            <td class="px-4 py-2 text-center text-sm">㎡</td>
                                                        ...
                                                        <tr>
                                                            <td class="px-2 md:px-4 py-2 text-xs md:text-sm">特殊器具使用料</td>
                                                            <td class="px-4 py-2 text-center text-sm">式</td>
                                                            <td class="px-4 py-2 text-center text-sm">1.00</td>
                                                            <td class="px-4 py-2 text-center text-sm">50000</td>
                                                            <td class="px-4 py-2 text-center text-sm">1</td>
                                            ...
                                            <div class="mt-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                                                <div class="text-xs md:text-sm text-gray-600">茨城県 | 清掃面積: 500㎡</div>
                                                <div class="text-sm md:text-lg font-bold text-blue-600">合計: ¥400,000</div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="p-4 md:p-6">
                                            <div class="overflow-x-auto -mx-4 md:mx-0">
                                                <table class="min-w-full text-xs md:text-sm">
                                                    ...
                                                    <tbody class="divide-y divide-gray-200">
                                                        <tr>
                                                            <td class="px-2 md:px-4 py-2 text-xs md:text-sm">緊急対応作業</td>
                                                            <td class="px-4 py-2 text-center text-sm">式</td>
                                                            <td class="px-4 py-2 text-center text-sm">1.00</td>
                                                        ...
                                                        <tr>
                                                            <td class="px-2 md:px-4 py-2 text-xs md:text-sm">夜間作業加算</td>
                                                            <td class="px-4 py-2 text-center text-sm">式</td>
                                                            <td class="px-4 py-2 text-center text-sm">1.00</td>
                                            ...
                                            <div class="mt-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                                                <div class="text-xs md:text-sm text-gray-600">栃木県 | 対応内容: 緊急対応</div>
                                                <div class="text-sm md:text-lg font-bold text-blue-600">合計: ¥150,000</div>
                                            </div>
                                        </div>
                                    </div>
