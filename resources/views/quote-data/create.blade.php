...
<div class="max-w-4xl mx-auto px-4 py-6 md:py-8">
    ...
    <div class="bg-blue-50 border border-blue-200 p-4 mb-6 md:mb-8">
    ...
    <form action="{{ route('quote-data.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6 md:space-y-8">
        ...
        <div class="bg-white shadow-md p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="work_type" name="work_type" required class="w-full p-3 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <div>
                    ...
                    <select id="prefecture" name="prefecture" required class="w-full p-3 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <option value="">選択してください</option>
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    ...
                    <div class="border-2 border-dashed border-gray-300 p-6 text-center hover:border-blue-400 hover:bg-blue-50 transition-colors">
        ...
        <div class="bg-white shadow-md p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <select id="order_status" name="order_status" class="w-full p-3 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <option value="">選択してください</option>
        ...
        <!-- 送信ボタン -->
        <div class="bg-white shadow-md p-6">
            <button type="submit" class="w-full bg-blue-600 text-white px-8 py-3 font-semibold hover:bg-blue-700 transition-colors">
                見積もりデータを投稿する
            </button>
        </div>
    </form>
