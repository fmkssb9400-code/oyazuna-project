...
@php
    ...
    $customMeta = [
        ...
        'hyogo_window-cleaning' => [
            'title' => '兵庫県の高所窓ガラス清掃業者一覧｜神戸三宮エリア対応で見積り無料',
            'description' => '兵庫県で高所窓ガラス清掃に対応する専門業者を10社掲載。人口減少が続く一方で再開発が進む神戸三宮エリアの事情も解説。無料で見積もり依頼できます。',
        ],
        'fukuoka_exterior-cleaning' => [
            'title' => '福岡県の外壁清掃、足場なしで依頼できる業者一覧｜見積り無料',
            'description' => '福岡県で足場を組まずに外壁清掃できる専門業者を10社掲載。天神ビッグバン・博多コネクティッドの再開発や北九州工業地帯の事情も解説。無料で見積もり依頼できます。',
        ],
    ];
