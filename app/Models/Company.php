...
class Company extends Model
{
    ...
    protected $casts = [
        ...
        'regular_work' => 'boolean',
        'reviews_reputation' => 'boolean',
        'case_studies' => 'boolean',
        'liability_insurance' => 'boolean',
        'workers_insurance' => 'boolean',
        'certified_staff' => 'boolean',
        'corporate_support' => 'boolean',
        'weekend_support' => 'boolean',
        'night_support' => 'boolean',
        'online_consultation' => 'boolean',
        'email_support' => 'boolean',
        'line_support' => 'boolean',
        'insurance' => 'boolean',
        'is_featured' => 'boolean',
        'areas' => 'array',
        'area_regions' => 'array',
