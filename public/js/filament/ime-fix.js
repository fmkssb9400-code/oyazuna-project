...
// 記事編集ページでは無効化（FileUpload干渉回避）
if (window.location.pathname.includes('/admin/articles/') && window.location.pathname.includes('/edit')) {
    console.log('🚫 ime-fix.js: 記事編集ページで無効化');
    return;
}
